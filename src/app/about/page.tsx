    ...
    <div className="bg-background">
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold font-headline text-primary">About Sivam Supermarket</h1>
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Sivam Supermarket was born from a simple idea: to provide the residents in the interior areas of Minjur with a reliable, friendly, and well-stocked grocery store. For years, our community faced the challenge of limited product availability and a lack of convenient services like door delivery.
            </p>
